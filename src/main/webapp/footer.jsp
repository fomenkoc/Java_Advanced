		...
		<div class="row">
			...
			<div class=" col-sm-4 col-md  col-6 col">
				...
				<ul class="footer_ul_amrc">
					...
					<li><a href="http://kalarikendramdelhi.com">Hollow Man
							Montage</a></li>
					<li><a href="http://kalarikendramdelhi.com">Ebay & Amazon</a></li>
					<li><a href="http://kalarikendramdelhi.com">Hair
			...
			<div class=" col-sm-4 col-md  col-6 col">
				...
				<ul class="footer_ul_amrc">
					<li><a href="http://kalarikendramdelhi.com">Remove
							Background</a></li>
					<li><a href="http://kalarikendramdelhi.com">Shadows &
							Mirror Reflection</a></li>
